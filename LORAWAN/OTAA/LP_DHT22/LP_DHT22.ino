...
static const u1_t PROGMEM DEVEUI[8] = { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x05, 0x02, 0xDD };
...
static const u1_t PROGMEM APPKEY[16] = { 0x63, 0x48, 0x1A, 0x1E, 0x16, 0x42, 0x3B, 0x32, 0x67, 0xDB, 0x59, 0x01, 0xF8, 0x93, 0x61, 0xD3 };
